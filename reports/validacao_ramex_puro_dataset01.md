...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 10A | RAMEX 2007 Rooted Branching | maximum_weight_rooted_branching | 202 | 201 | 10068.00 | 6.33 | True | True | SOURCE |
...
O metodo com maior percentagem de peso preservado foi: **RAMEX 2007 Rooted Branching (6.33%)**.

## 4. Metodo mais simples

Os metodos mais simples, considerando o menor numero de arestas selecionadas, sao: **RAMEX Forward Heuristic (199 arestas), RAMEX Back-and-Forward Heuristic (199 arestas)**.
