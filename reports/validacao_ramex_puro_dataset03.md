...
Em grafos de estrutura intermédia, a leitura deve equilibrar peso preservado, simplicidade e capacidade de representar relações estruturais relevantes.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 10A | RAMEX 2007 Rooted Branching | maximum_weight_rooted_branching | 6 | 5 | 165.00 | 36.50 | True | True | SOURCE |
...
Os metodos mais simples, considerando o menor numero de arestas selecionadas, sao: **RAMEX Forward Heuristic (3 arestas), RAMEX Back-and-Forward Heuristic (3 arestas)**.
