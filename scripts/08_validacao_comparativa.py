...
DATASETS = {
    "Dataset 01": {"graph_edges": "data/csv/grafo_edges_dataset01.csv", "ramex_edges": "data/csv/ramex_dataset01.csv"},
    "Dataset 02": {"graph_edges": "data/csv/grafo_edges_dataset02.csv", "ramex_edges": "data/csv/ramex_dataset02.csv"},
    "Dataset 03": {"graph_edges": "data/csv/grafo_edges_dataset03.csv", "ramex_edges": "data/csv/ramex_dataset03.csv"},
}

GRAPH_COLUMNS = ["From", "To", "Weight"]
RAMEX_COLUMNS = ["From", "To", "Weight", "Level"]
OUTPUT_CSV = "data/csv/validacao_comparativa.csv"
OUTPUT_TXT = "data/processed/validacao_comparativa.txt"
