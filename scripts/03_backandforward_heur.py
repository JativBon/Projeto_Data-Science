...
df_freq.to_csv("frequencias_pares_dataset03.csv", index=False)
...
plt.title("Ramex simplificado - Back-and-Forward Heuristic")
plt.savefig("grafo_ramex_simplificado_back_forward.png", dpi=300, bbox_inches="tight")
plt.show()

print("\nFicheiro gerado: grafo_ramex_simplificado_back_forward.png")
