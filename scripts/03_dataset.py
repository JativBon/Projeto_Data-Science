...
caminho_dataset = Path("data/raw/dataset 03.xlsx")
...
df_seq.to_csv(CSV_DIR / "sequencias_dataset03.csv", index=False)

print("\nFicheiro gerado com sucesso: data/csv/sequencias_dataset03.csv")

# Guarda as sequencias validas tambem em txt
with (PROCESSED_DIR / "sequencias_dataset03.txt").open("w", encoding="utf-8") as ficheiro_saida:
    for seq in sequencias:
        ficheiro_saida.write(" ".join(seq) + "\n")

print("Ficheiro gerado com sucesso: data/processed/sequencias_dataset03.txt")
